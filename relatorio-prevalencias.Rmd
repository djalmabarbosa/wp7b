...
dadoswp7$variables$transbip[is.na(dadoswp7$variables$transbip)] = "Não"
dadoswp7$variables$toc[is.na(dadoswp7$variables$toc)] = "Não"
...
Idade = as.factor(ifelse(idade<18,"Menor de 18",
...
tbl_svysummary(dadoswp7,by = QualquerTipoMedit, 
...
tbl_svysummary(dadoswp7,by = FezMeditacao12m, 
               include=c(Regiao,Sexo,Idade,CorRaca3,EmRelacionamento,NivelEducacional,RendaFamiliarPc,
               VisitasDoAC12m,TemPlanoSaude,
               DoencasCronicas,TranstornosMentais,
               Artrite,Asma,Hipercolesterol,Diabetes,DORT,Hipertensao,InsRenCronica,DoenCronPul,
...
```{r Características - meditação 2, eval=F, echo=FALSE, message=F, warning=F}
...
tbl_svysummary(dadoswp7,by = FezYoga12m, 
               include=c(Regiao,Sexo,Idade,CorRaca3,EmRelacionamento,NivelEducacional,RendaFamiliarPc,
               VisitasDoAC12m,TemPlanoSaude,
               DoencasCronicas,TranstornosMentais,
               Artrite,Asma,Hipercolesterol,Diabetes,DORT,Hipertensao,InsRenCronica,DoenCronPul,
...
tbl_svysummary(dadoswp7,by = FezTaix12m, 
               include=c(Regiao,Sexo,Idade,CorRaca3,EmRelacionamento,NivelEducacional,RendaFamiliarPc,
               VisitasDoAC12m,TemPlanoSaude,
               DoencasCronicas,TranstornosMentais,
               Artrite,Asma,Hipercolesterol,Diabetes,DORT,Hipertensao,InsRenCronica,DoenCronPul,
