...
dadoswp7$variables$DiagDepressao[is.na(dadoswp7$variables$depressao)] = "Não"
dadoswp7$variables$DiagTransBip[is.na(dadoswp7$variables$transbip)] = "Não"
dadoswp7$variables$DiagTOC[is.na(dadoswp7$variables$toc)] = "Não"
...
transtornomentalx = Depressao+TOC+TransBip,
TranstornoMental = ifelse(transtornomentalx == 0, "Nenhuma",
                         ifelse(transtornomentalx == 1, "Uma",
                                ifelse(transtornomentalx == 2, "Duas","Três"))),
