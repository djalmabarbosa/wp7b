...
colnames(dadoswp7$variables)[which(names(dadoswp7$variables) == "Q092")] <- "DiagDepressao"
colnames(dadoswp7$variables)[which(names(dadoswp7$variables) == "Q11008")] <- "DiagTransBip"
colnames(dadoswp7$variables)[which(names(dadoswp7$variables) == "Q11009")] <- "DiagTOC"
...
dadoswp7$variables$DiagDepressao[is.na(dadoswp7$variables$DiagDepressao)] = "Não"
dadoswp7$variables$DiagTransBip[is.na(dadoswp7$variables$DiagTransBip)] = "Não"
dadoswp7$variables$DiagTOC[is.na(dadoswp7$variables$DiagTOC)] = "Não"
...
DiagDepressao2 = ifelse(DiagDepressao == "Sim",1,0),
cronicasx = Artrite+Asma+Hipercolesterol+Diabetes+Hipertensao+InsRenCronica+DoenCronPul+DiagDepressao2,
...
levels(dadoswp7$variables$RendaFamiliarPc) <- c("R$0-499,99", "R$500-1087,99 ","R$1088 ou mais")
...
dadoswp7$variables$DORT <- factor(dadoswp7$variables$DORT,
                                              levels = c("Não", "Sim"))
dadoswp7$variables$DiagDepressao <- factor(dadoswp7$variables$DiagDepressao,
                                              levels = c("Não", "Sim"))
dadoswp7$variables$DiagTransBip <- factor(dadoswp7$variables$DiagTransBip,
                                              levels = c("Não", "Sim"))
dadoswp7$variables$DiagTOC <- factor(dadoswp7$variables$DiagTOC,
                                              levels = c("Não", "Sim"))
...
dadoswp7$variables <- dadoswp7$variables %>% 
  select(FezMeditacao12m,FezYoga12m,FezTaix12m,QualquerTipoMedit,
         ...
         DiagDepressao,DiagTransBip,DiagTOC,
...
dadoswp7$variables$VisitasDoAC12m <- relevel(dadoswp7$variables$VisitasDoAC12m, ref = "Nunca recebeu")
...
### Descrição das Prevalências  

<br/>


```{r Prevalências, eval=TRUE, echo=FALSE, message=F, warning=F}

library(gtsummary)
tbl_svysummary(dadoswp7, include=c(FezMeditacao12m,FezYoga12m,FezTaix12m,QualquerTipoMedit,
