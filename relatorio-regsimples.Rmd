...
logit1 <- (svyglm(FezMeditacao12m~TranstornosMentais, family=quasibinomial, design=dadoswp7a, na.action = na.omit))
logit2 <- (svyglm(FezYoga12m~TranstornosMentais, family=quasibinomial, design=dadoswp7a, na.action = na.omit))
logit3 <- (svyglm(FezTaix12m~TranstornosMentais, family=quasibinomial, design=dadoswp7a, na.action = na.omit))

Notes <- "<span>&#9768;&#9768;&#9768;</span>: p<0.01; <span>&#9768;&#9768;</span>: p<0.05; <span>&#9768;</span>: p<0.1"
covlabels <- levels(dadoswp7a$variables$TranstornosMentais)[-1]
noteslabel <- paste("Variável Independente:", names(dadoswp7a$variables)[15], ";  Cagetoria de referência:",
                    levels(dadoswp7a$variables$TranstornosMentais)[1])
...
logit1 <- (svyglm(FezMeditacao12m~TransBip, family=quasibinomial, design=dadoswp7a, na.action = na.omit))
logit2 <- (svyglm(FezYoga12m~TransBip, family=quasibinomial, design=dadoswp7a, na.action = na.omit))
logit3 <- (svyglm(FezTaix12m~TransBip, family=quasibinomial, design=dadoswp7a, na.action = na.omit))

Notes <- "<span>&#9768;&#9768;&#9768;</span>: p<0.01; <span>&#9768;&#9768;</span>: p<0.05; <span>&#9768;</span>: p<0.1"
covlabels <- levels(dadoswp7a$variables$TransBip)[-1]
noteslabel <- paste("Variável Independente:", names(dadoswp7a$variables)[25], ";  Cagetoria de referência:",
                    levels(dadoswp7a$variables$TransBip)[1])
...
logit1 <- (svyglm(FezMeditacao12m~TOC, family=quasibinomial, design=dadoswp7a, na.action = na.omit))
logit2 <- (svyglm(FezYoga12m~TOC, family=quasibinomial, design=dadoswp7a, na.action = na.omit))
logit3 <- (svyglm(FezTaix12m~TOC, family=quasibinomial, design=dadoswp7a, na.action = na.omit))

Notes <- "<span>&#9768;&#9768;&#9768;</span>: p<0.01; <span>&#9768;&#9768;</span>: p<0.05; <span>&#9768;</span>: p<0.1"
covlabels <- levels(dadoswp7a$variables$TOC)[-1]
noteslabel <- paste("Variável Independente:", names(dadoswp7a$variables)[26], ";  Cagetoria de referência:",
                    levels(dadoswp7a$variables$TOC)[1])
