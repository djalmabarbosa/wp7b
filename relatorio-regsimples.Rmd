...
logit1 <- (svyglm(FezMeditacao12m~TranstornoMental, family=quasibinomial, design=dadoswp7a, na.action = na.omit))
logit2 <- (svyglm(FezYoga12m~TranstornoMental, family=quasibinomial, design=dadoswp7a, na.action = na.omit))
logit3 <- (svyglm(FezTaix12m~TranstornoMental, family=quasibinomial, design=dadoswp7a, na.action = na.omit))

Notes <- "<span>&#9768;&#9768;&#9768;</span>: p<0.01; <span>&#9768;&#9768;</span>: p<0.05; <span>&#9768;</span>: p<0.1"
covlabels <- levels(dadoswp7a$variables$TranstornoMental)[-1]
noteslabel <- paste("Variável Independente:", names(dadoswp7a$variables)[15], ";  Cagetoria de referência:",
                    levels(dadoswp7a$variables$TranstornoMental)[1])
